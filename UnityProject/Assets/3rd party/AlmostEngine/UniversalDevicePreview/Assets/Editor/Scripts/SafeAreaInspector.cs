...
{
	[CustomEditor (typeof(SafeAreaCustom))]
	[CanEditMultipleObjects]
	public class SafeAreaInspector : Editor
	{
		protected SafeAreaCustom m_SafeArea;


		void OnEnable ()
		{
			m_SafeArea = (SafeAreaCustom)target;
		}
		...
		public override void OnInspectorGUI ()
		{
			...
			if (m_SafeArea.gameObject.activeInHierarchy
			    && m_SafeArea.m_HorizontalConstraintType != SafeAreaCustom.Constraint.NONE
			...
			if (m_SafeArea.gameObject.activeInHierarchy
			    && m_SafeArea.m_VerticalConstraintType != SafeAreaCustom.Constraint.NONE
			    && m_SafeArea.m_Panel.parent.GetComponent<Canvas> () == null
			...
			if (m_SafeArea.m_HorizontalConstraintType != SafeAreaCustom.Constraint.NONE) {
			...
			if (m_SafeArea.m_VerticalConstraintType != SafeAreaCustom.Constraint.NONE) {
