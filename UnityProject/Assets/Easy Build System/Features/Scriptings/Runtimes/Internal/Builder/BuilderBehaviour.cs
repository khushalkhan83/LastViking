...
namespace EasyBuildSystem.Runtimes.Internal.Builder
{
    ...
    public class BuilderBehaviour : MonoBehaviour
    {
        ...
        public Transform GetTransform
        {
            get {
                return CameraType != RayType.TopDown ? transform.parent != null ? transform.parent
                    : BuilderCamera.transform : RaycastAnchorTransform != null ? RaycastAnchorTransform : BuilderCamera.transform.transform;
            }
        }

        public TutorialBuildingModel TutorialBuildingModel => ModelsSystem.Instance._tutorialBuildingModel;
        public ConstructionModel ConstructionModel => ModelsSystem.Instance._constructionModel;
        ...
        public void UpdatePreview()
        {
            ...
            if(!TutorialBuildingModel.OnIsPlacementAllowed(CurrentSocket))
        ...
        public void UpdateSnapsMovement(SocketBehaviour[] sockets)
        {
            ...
            for (int i = 0; i < sockets.Length; i++)
            {
                ...
                if(!TutorialBuildingModel.OnCanPartSnap(Part))
                    continue;
        ...
        public virtual void PlacePrefab()
        {
            ...
            ConstructionModel.PlacePart(SelectedPrefab?.Name);
        ...
        {
            SelectedPrefab = BuildManager.Instance.GetPart(id);
        }
