...
namespace EasyBuildSystem.Runtimes.Events
{
    public class EventHandlers
    {
        ...
        public delegate GameObject EventHandlerPrePlacePart(PartBehaviour part, Vector3 position, Vector3 rotation);

        public static event EventHandlerPrePlacePart OnPrePlacePart;

        /// <summary>
        /// (Not asset part!). Delegate game object creation to other place
        /// </summary>
        public static GameObject PrePlacedPart(PartBehaviour part, Vector3 position, Vector3 rotation)
        {
            return OnPrePlacePart?.Invoke(part, position, rotation);
        }
