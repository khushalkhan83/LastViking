    ...
    public class DesktopBuilderBehaviourEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (BaseFoldout)
            {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty("BuilderCamera"), new GUIContent("Raycast Builder Camera :", "(not original) Camera which is used by raycasting for building"));
