...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	public sealed class ObscuredString : IComparable<ObscuredString>, IComparable<string>, IComparable
	{
        ...
        public int Length => hiddenValue.Length / sizeof(char);

        public static implicit operator ObscuredString(string value) => value == null ? null : new ObscuredString(value);

        public static implicit operator string(ObscuredString value) => value?.InternalDecrypt();
