...
#pragma warning disable 0649
		...
		[SerializeField] private int _clicksInDebugMode = 2;
        [SerializeField] private int _clicksInReleaseMode = 15;
...
#pragma warning restore 0649
		...
		private int ClicksToOpen
        {
            get
            {
                if (IsReleaseBuild())
                {
                    return _wasOpened ? _clicksInDebugMode : _clicksInReleaseMode;
                }
                else
                {
                    return _clicksInDebugMode;
                }
