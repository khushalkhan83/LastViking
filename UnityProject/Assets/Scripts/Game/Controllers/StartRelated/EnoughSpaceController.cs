...
{
    public class EnoughSpaceController : IEnoughSpaceController, IController
    {
        ...
        private void OpenNoSpaceForSaveExitPopupView()
        {
            ...
            {
                NoSpaceForSaveExitPopupView = ViewsSystem.Show<NoSpaceForSaveExitPopupView>(ViewConfigID.NoSpaceForSaveExitConfig);
