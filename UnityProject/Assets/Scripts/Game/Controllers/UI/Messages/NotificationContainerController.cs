...
{
    public class NotificationContainerController : INotificationContainerController, IController
    {
        ...
        private void ShowView()
        {
            if (View == null)
            {
                View = ViewsSystem.Show<NotificationContainerView>(ViewConfigID.NotificationContainer);
