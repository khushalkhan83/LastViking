...
{
    public class ResourceMessagesController : IResourceMessagesController, IController
    {
        ...
        private void ShowView()
        {
            if (View == null)
            {
                View = ViewsSystem.Show<ResourceMessagesView>(ViewConfigID.ResourceMessages);
