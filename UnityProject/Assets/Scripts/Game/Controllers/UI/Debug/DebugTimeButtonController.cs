...
{
    public class DebugTimeButtonController : IDebugTimeButtonController, IController
    {
        ...
        private void ShowView()
        {
            if (View == null)
            {
                View = ViewsSystem.Show<DebugTimeInteractView>(ViewConfigID.DebugTimeInteract);
