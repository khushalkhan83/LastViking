...
{
    public class TouchpadController : ITouchpadController, IController
    {
        ...
        {
            // StorageModel.TryProcessing(TouchpadModel._Data);
        ...
        private void ShowView()
        {
            if (View == null)
            {
                View = ViewsSystem.Show<TouchpadView>(ViewConfigID.Touchpad);
