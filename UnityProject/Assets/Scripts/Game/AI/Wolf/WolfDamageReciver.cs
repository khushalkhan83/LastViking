...
{
    public class WolfDamageReciver : MonoBehaviour, IDamageable, IHitReciver, IOutlineTarget
    {
        #region Data
#pragma warning disable 0649
        ...
        [SerializeField] private Vector3 _targetingShift = Vector3.zero;
...
#pragma warning restore 0649
        ...
        public event Action<IHitReciver> onUpdateRendererList;
        ...
        void IDamageable.Damage(float value, GameObject from)
        {
            ...
            if (Health.IsDead)
            {
                ...
                if (random <= 50f)
                {
                    CoinObjectsModel.SpawnAtPosition(GoldForKill, transform.position, transform.position + Vector3.up, 2f, AnimalID.Wolf.ToString());
                }
                else
                {
                ...
                AnimalsModel.TargetKillAnimal(fromTarget, AnimalID.Wolf);
            }
            else
            {
