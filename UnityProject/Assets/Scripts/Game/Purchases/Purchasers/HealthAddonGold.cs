...
{
    public class HealthAddonGold : PurchaserBase, IPurchaseCoinInfo
    {
        #region Data
...
#pragma warning restore 0649
        ...
        public int CoinCost => FirebaseRemoteSettingsModel.GetParam<HealthAddonRemoteSettings>(FirebaseRemoteSettingID.HealthAddon).AddonGold;
