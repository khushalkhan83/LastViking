...
{
    public class TombTakeItemsGold : PurchaserBase, IPurchaseCoinInfo
    {
        #region Data
...
#pragma warning restore 0649
        ...
        public int CoinCost => FirebaseRemoteSettingsModel.GetParam<TombRemoteSettings>(FirebaseRemoteSettingID.Tomb).TakeItemsGold;
