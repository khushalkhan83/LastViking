...
{
    public class WaterAddonGold : PurchaserBase, IPurchaseCoinInfo
    {
        #region Data
...
#pragma warning restore 0649
        ...
        public int CoinCost => FirebaseRemoteSettingsModel.GetParam<WaterAddonRemoteSettings>(FirebaseRemoteSettingID.WaterAddon).AddonGold;
