...
{
    public class MilitaryChaestSlotBuyGold : PurchaserBase, IPurchaseCoinInfo
    {
        #region Data
...
#pragma warning restore 0649
        ...
        public int CoinCost => FirebaseRemoteSettingsModel.GetParam<MilitaryChestRemoteSettings>(FirebaseRemoteSettingID.MilitaryChest).BuySlotGold;
