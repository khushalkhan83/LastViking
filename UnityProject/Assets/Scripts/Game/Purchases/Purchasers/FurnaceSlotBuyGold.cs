...
{
    public class FurnaceSlotBuyGold : PurchaserBase, IPurchaseCoinInfo
    {
        #region Data
...
#pragma warning restore 0649
        ...
        public int CoinCost => FirebaseRemoteSettingsModel.GetParam<FurnaceRemoteSettings>(FirebaseRemoteSettingID.Furnace).BuySlotGold;
