...
{
    public class LoomSlotBuyGold : PurchaserBase, IPurchaseCoinInfo
    {
        #region Data
...
#pragma warning restore 0649
        ...
        public int CoinCost => FirebaseRemoteSettingsModel.GetParam<LoomRemoteSettings>(FirebaseRemoteSettingID.Loom).BuySlotGold;
