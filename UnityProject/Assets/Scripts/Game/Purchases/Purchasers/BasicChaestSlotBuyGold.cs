...
{
    public class BasicChaestSlotBuyGold : PurchaserBase, IPurchaseCoinInfo
    {
        #region Data
...
#pragma warning restore 0649
        ...
        public int CoinCost => FirebaseRemoteSettingsModel.GetParam<BasicChestRemoteSettings>(FirebaseRemoteSettingID.BasicChest).BuySlotGold;
