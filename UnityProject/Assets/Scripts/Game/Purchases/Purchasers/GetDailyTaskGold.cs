...
{
    public class GetDailyTaskGold : PurchaserBase, IPurchaseCoinInfo 
    {
        #region Data
...
#pragma warning restore 0649
        ...
        public int CoinCost => FirebaseRemoteSettingsModel.GetParam<SkipObjectivesRemoteSettings>(FirebaseRemoteSettingID.SkipObjectives).SkipGold;
