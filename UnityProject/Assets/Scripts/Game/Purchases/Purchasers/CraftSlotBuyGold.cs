...
{
    public class CraftSlotBuyGold : PurchaserBase, IPurchaseCoinInfo
    {
        #region Data
...
#pragma warning restore 0649
        ...
        public int CoinCost => FirebaseRemoteSettingsModel.GetParam<CraftRemoteSettings>(FirebaseRemoteSettingID.Craft).BuySlotGold;
