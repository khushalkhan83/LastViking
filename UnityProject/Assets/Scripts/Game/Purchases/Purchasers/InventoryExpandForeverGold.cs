...
{
    public class InventoryExpandForeverGold : PurchaserBase, IPurchaseCoinInfo
    {
        #region Data
...
#pragma warning restore 0649
        ...
        public int CoinCost => FirebaseRemoteSettingsModel.GetParam<InventoryRemoteSettings>(FirebaseRemoteSettingID.Inventory).ExpandForeverSlotGold;
