...
#pragma warning disable 0649
        ...
        [SerializeField] private Transform m_LeftHips;

        [SerializeField] private Transform m_LeftKnee;

        [SerializeField] private Transform m_LeftFoot;

        [SerializeField] private Transform m_RightHips;

        [SerializeField] private Transform m_RightKnee;

        [SerializeField] private Transform m_RightFoot;

        [SerializeField] private Transform m_LeftArm;

        [SerializeField] private Transform m_LeftElbow;

        [SerializeField] private Transform m_RightArm;

        [SerializeField] private Transform m_RightElbow;

        [SerializeField] private Transform m_MiddleSpine;

        [SerializeField] private Transform m_Head;

        [Header("Joint Settings")]

        [SerializeField] private bool m_EnableProjection = true;

        [Header("Ragdoll Settings")]

        [SerializeField] private float m_TotalMass = 60f;

        [SerializeField] private bool m_FlipForward;
