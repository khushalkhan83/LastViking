...
#pragma warning disable 0649
        ...
        [SerializeField] private float _spread = 1.8f;
...
#pragma warning restore 0649
        ...
        private void SpawnArrow(Camera camera)
        {
            ...
            var spreadVector = camera.transform.TransformVector(new Vector3(Random.Range(-_spread, _spread), Random.Range(-_spread, _spread), 0f));
