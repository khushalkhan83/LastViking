...
#pragma warning disable 0649
        ...
        [SerializeField] private Sway m_MovementSway;

        [SerializeField] private Sway m_RotationSway;

        [Header("Bob")]

        [SerializeField] private TrigonometricBob m_WalkBob;

        [SerializeField] private TrigonometricBob m_AimBob;

        [SerializeField] private TrigonometricBob m_RunBob;

        [SerializeField] private LerpControlledBob m_LandBob;

        [SerializeField] private float m_MaxLandSpeed = 12f;

        [Header("Offset")]

        [SerializeField] private TransformOffset m_IdleOffset;

        [SerializeField] private TransformOffset m_RunOffset;

        [SerializeField] private TransformOffset m_AimOffset;

        [SerializeField] private TransformOffset m_OnLadderOffset;

        [SerializeField] private TransformOffset m_JumpOffset;
        ...
        [SerializeField] private TransformOffset m_TooCloseOffset;

#pragma warning restore 0649
        #endregion

        public PlayerRunModel PlayerRunModel => ModelsSystem.Instance._playerRunModel;
        ...
        private void Update()
        {
            var input = Player.LookInput.Value;
            ...
            // Movement bobs.
            var moveSpeed = Player.Velocity.Value.magnitude;
            var totalBob = Vector3.zero;
