...
#pragma warning disable 0649
        ...
        [SerializeField] private SoundPlayer m_FootstepSounds;

        [SerializeField] private SoundPlayer m_JumpSounds;

        [SerializeField] private SoundPlayer m_LandSounds;

        [SerializeField] private SoundPlayer m_WaterstepSounds;

        [Header("Bullet Impact")]

        [SerializeField] private SoundPlayer m_BulletImpactSounds;

        [SerializeField] private PooledObject[] m_BulletDecals;

        [SerializeField] private PooledObject[] m_BulletImpactFX;

        [Header("Chop & Hit")]

        [SerializeField] private SoundPlayer m_ChopSounds;

        [SerializeField] private SoundPlayer m_HitSounds;

        [SerializeField] private PooledObject[] m_ChopFX;

        [SerializeField] private PooledObject[] m_HitFX;

        [Header("Penetration")]

        [SerializeField] private bool m_IsPenetrable;

        [SerializeField] private SoundPlayer m_SpearPenetrationSounds;

        [SerializeField] private SoundPlayer m_ArrowPenetrationSounds;
...
#pragma warning restore 0649
        ...
        public void PlaySound(ItemSelectionMethod selectionMethod, SoundType soundType, float volumeFactor = 1f, AudioSource audioSource = null)
        {
            ...
            else if (soundType == SoundType.Waterstep)
                m_WaterstepSounds.Play(selectionMethod, audioSource, volumeFactor);
