...
namespace UltimateSurvival
{
    ...
    public class ItemHolder
    {
        ...
        public bool TryAddItem(ItemData itemData, int amount, out int added, List<ItemProperty.Value> customPropertyValues = null)
        {
            ...
            int oldValue = CurrentItem.Count;
            ...
            CurrentItem.Count = currentInStack;
        ...
        public void RemoveFromStack(int amount, out int removed)
        {
            ...
            {
                removed = CurrentItem.Count;
                SetItem(null);

                return;
            }

            int oldStack = CurrentItem.Count;
            CurrentItem.Count = Mathf.Max(CurrentItem.Count - amount, 0);
            removed = oldStack - CurrentItem.Count;
